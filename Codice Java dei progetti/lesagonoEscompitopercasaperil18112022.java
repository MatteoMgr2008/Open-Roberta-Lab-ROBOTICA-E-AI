...
public class lesagonoEscompitopercasaperil18112022 {
    ...
    public static void main(String[] args) {
        try {
            ...
            new lesagonoEscompitopercasaperil18112022().run();
        } catch ( Exception e ) {
    ...
    public void run() throws Exception {
        ...
        for ( float ___k0 = 0; ___k0< 2; ___k0+= 1 ) {
            ...
            hal.driveDistance(DriveDirection.FOREWARD, 50, 40);
            hal.rotateDirectionAngle(TurnDirection.RIGHT, 30, 70);
            hal.driveDistance(DriveDirection.FOREWARD, 50, 40);
            hal.rotateDirectionAngle(TurnDirection.RIGHT, 30, 62);
            hal.driveDistance(DriveDirection.FOREWARD, 50, 20);
        }
    }
}